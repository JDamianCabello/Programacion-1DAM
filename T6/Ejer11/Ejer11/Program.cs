...
namespace Ejer11
{
    class Program
    {
        ...
        {
            NumLetra unNumero = new NumLetra();
            ...
            for (int i = 0; i < 20; i++)
            {
                aux = GetRandomNumber(0, 1000000000);
                if(i <= 9)
                    Console.WriteLine(unNumero.Convertir(aux.ToString(), false));
                else
                    Console.WriteLine(unNumero.Convertir(aux.ToString(), true));

                Thread.Sleep(200);
            }
            Console.WriteLine(unNumero.Convertir("999999999,99", false));
            Console.WriteLine(unNumero.Convertir("999999999,99", true));
    ...
    class NumLetra
    {
        ...
        public String Convertir(String numero, bool mayusculas)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                //parte_decimal = Convert.ToInt32(Num[1])/10000 + " Euros.";
