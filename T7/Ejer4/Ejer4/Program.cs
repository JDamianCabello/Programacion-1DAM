...
namespace Ejer4
{
    class Program
    {
        ...
        {
            int numero = 0;
            string[] opciones = { "Factorial Recursivo", "Factorial Iterativo", "Fibonacci Recursivo", "Fibonacci Iterativo", "Suma Iterativa", "Suma Recursiva", "Es Primo", "Salir (también vale la tecla Esc)" };
